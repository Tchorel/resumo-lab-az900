📘 Desafio DIO – Fundamentos Azure (AZ-900)
...
- Nuvem Pública – Infraestrutura compartilhada (ex: Azure)
...
- OpEx (Operational Expenditure) → Pagamento pelo uso (modelo da nuvem)
...
Sistema de controle de versão distribuído que permite:
...
O Azure oferece serviços de Inteligência Artificial como:
...
Permite integração de modelos de IA para:
...
- Contribuição em projetos colaborativos
...
Joel Ferreira
Estudante da trilha Microsoft Azure – DIO
Em preparação para a certificação AZ-900 ☁️🚀
